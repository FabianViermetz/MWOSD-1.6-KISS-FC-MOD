...
// KISS_FC specific
#define KSP_TLM                  32    // requestbyte for total Telemetry
#define KSP_CONF                 48    // requestbyte for total config
...
const char configMsg08[] PROGMEM = "MAX TEMPERATURE";
//-----------------------------------------------------------Page1
