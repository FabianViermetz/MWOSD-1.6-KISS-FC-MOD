...
#define PROTOCOL_MSP // standard defined 
...
#if defined (KISS_FC)
  #undef PROTOCOL_MSP
  #define FORCESENSORS_MINIMUM
//  #define AMPERAGE_DIV 100
  #define MENU0  0 //STATISTICS
  #define MENU1  1 //PID CONFIG
  //#define MENU2  2 //RC TUNING
  #define MENU3  2 //VOLTAGE
  #define MENU4  3 //RSSI
  #define MENU5  4 //CURRENT
  #define MENU6  5 //DISPLAY
  #define MAXPAGE MENU6   
#endif
...
#elif defined MSP_SPEED_MED || defined MSP_SPEED_LOW
