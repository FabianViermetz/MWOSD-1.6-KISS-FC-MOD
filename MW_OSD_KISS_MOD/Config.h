...
// latest release...
#define KISS_FC                   // Uncomment this if you are using KISS_FC
...
/********************       STARTUP settings      *********************/
#define INTRO_VERSION               "MWOSD - 1.6.KISS" // Call the OSD something else if you prefer. KVOSD is not permitted - LOL.
...
#define KISS_ESC_TEMP               // enable for kiss 24A ESC temperature support
#define TEMPERATUREMAX 80           // Temperature warning value
